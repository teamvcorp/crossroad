...
const Navbar: React.FC = () => {
  ...
  return (
    <nav ref={navbarRef} className="bg-darkBlue py-3">
      {/* Mobile Menu Toggle */}
      ...
      <ul
        ...
        } md:flex space-y-4 md:space-y-0 md:space-x-6 justify-center px-4 md:px-0 relative`}
      >
        {/* Who We Are */}
        <li className="relative">
          <button
            className="text-white flex items-center gap-2 text-lg hover:text-yellow-400 transition-colors duration-300 w-full md:w-auto"
            onClick={() => handleDropdown("whoWeAre")}
          >
            Who We Are <IoIosArrowDown />
          </button>
          {activeDropdown === "whoWeAre" && (
            <ul className="absolute bg-white text-black mt-2 shadow-lg rounded w-48 md:static md:w-auto md:mt-0 md:shadow-none">
              ...
              <li className="hover:bg-darkBlue hover:text-white">
                <Link href="/aboutus/mission#vision" className="block px-4 py-2">
                  Vision
                </Link>
              </li>
              <li className="hover:bg-darkBlue hover:text-white">
        ...
        <li className="relative">
          <button
            className="text-white text-lg flex items-center gap-2 hover:text-yellow-400 transition-colors duration-300 w-full md:w-auto"
        ...
        <li>
          <Link
            href="/contact"
            className="text-white text-lg hover:text-yellow-400 transition-colors duration-300 block"
          >
            Contact
          </Link>
        </li>
        ...
        <li>
          <Link
            href="/supportpage"
            className="text-white text-lg flex items-center gap-2 hover:text-yellow-400 transition-colors duration-300 block"
          >
