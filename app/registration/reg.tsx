...
export default function ParentForm() {
  ...
  return (
    <div className="min-h-screen bg-blue-600 flex items-center justify-center pt-[95px]">
      <div className="max-w-3xl w-full bg-white text-gray-800 p-6 rounded-lg shadow-lg">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <h2 className="text-2xl font-bold text-blue-600 mt-6">Children Information</h2>
